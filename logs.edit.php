...
$result_count = mysqli_query($conn, "SELECT * FROM editlogs;") or die(mysqli_error($mysqli));
...
//query string
$sql = "SELECT * FROM editlogs ORDER BY dateAndTime DESC LIMIT $offset , $total_records_per_page";
// result
